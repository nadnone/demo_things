...
function bresenham_calculus_y(k, objet, l, m)
{
    let a = 0;
...
function bresenham_calculus_x(k, objet, l, m)
{
...
function condition_loop(m, objet, k, l)
{
    ...
    m = bresenham_calculus_x(k, objet, l, m);
    m = bresenham_calculus_y(k, objet, l, m);
